...
ALLOWED_EXTENSIONS = {"pdf", "docx", "txt", "csv", "xlsx", "xls", "pptx", "ppt", "md", "markdown"}
...
FINAL_CONTEXT_CHUNKS = _int("FINAL_CONTEXT_CHUNKS", _int("FINAL_CONTEXT_K", 6))
FINAL_CONTEXT_K = FINAL_CONTEXT_CHUNKS

# Distance threshold for normalized embeddings (cos_sim = 1 - distance/2)
# Distance <= 1.48 allows cos_sim >= 0.26
