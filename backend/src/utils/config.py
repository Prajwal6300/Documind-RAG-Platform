...
DATABASE_URL = os.getenv("DATABASE_URL", _get_val("storage", "database_url", "DATABASE_URL", "")).strip()
...
# --- CORS & Rate Limiting ----------------------------------------------------
# Comma-separated list of allowed origins, e.g. CORS_ORIGINS=http://localhost:5173,https://documind.example.com
